...
function Sidenav() {
  return (
    <>
      <div className="hidden md:block w-[20%] h-[100%] border-r-2 border-zinc-400 p-10">
        ...
        <nav className="flex flex-col text-zinc-400 text-sm">
          ...
          <Link to="/tv" className="hover:bg-[#6556CD] hover:text-white rounded-lg  p-5">
            <i className="ri-tv-fill"></i> TV Shows
          </Link>
          <Link to="/person" className="hover:bg-[#6556CD] hover:text-white rounded-lg  p-5">
